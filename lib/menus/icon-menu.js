...
var IconMenu = React.createClass({
  ...
  render: function render() {
    ...
    var other = _objectWithoutProperties(_props, ['closeOnItemTouchTap', 'iconButtonElement', 'iconStyle', 'openDirection', 'onItemTouchTap', 'onKeyboardFocus', 'onMouseDown', 'onMouseLeave', 'onMouseEnter', 'onMouseUp', 'onTouchTap', 'menuStyle', 'style']);
